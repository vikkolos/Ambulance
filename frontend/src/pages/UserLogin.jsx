  ...
  return (
    <>
        <div className="inset-0 fixed flex flex-col items-start justify-center h-screen w-screen overflow-hidden">
            ...
            <div className='h-1/2 w-full bg-[#f0f0f08e] '></div>

            {/* This form or new user(patient) registration page allow to create an account as a patient. */}
            ...
            <form className={`${hasAccount && 'translate-y-[100%] opacity-0 '}  px-5 py-3 rounded-md bg-white h-[79%] w-[94%] absolute left-1/2 bottom-[2%] translate-x-[-50%] z-10} transition-all duration-500 ease-in-out`}>
              ...
              <span className='flex items-center justify-center w-full mt-5 text-[#525151]'>Already have an account? <span onClick={()=>toggleUserAccount(false)} className='ml-4 text-blue-400 font-semibold'>Log In</span></span>
            </form>

            {/* This form or new user(patient) login page allow to login an account as a patient. */}
            ...
            <form className={`${!hasAccount && 'translate-y-[100%] opacity-0 '} px-5 py-3 rounded-md bg-white h-[79%] w-[94%] absolute left-1/2 bottom-[2%] translate-x-[-50%] z-10} transition-all duration-500 ease-in-out`}>
              ...
              <span className='flex items-center justify-center w-full mt-5 text-[#525151]'><span onClick={()=>toggleUserAccount(true)} className='ml-4 text-blue-400 font-semibold'>Create new account</span></span>
            </form>
